...
namespace AspNetCore.Ignite
{
    public class IgniteManager : IIgniteManager
    {
        ...
        public IgniteManager(IConfiguration configuration)
        {
            ...
            bool aspNetCoreIgniteUseSsl = "true".Equals(configuration["ASPNETCORE_IGNITE_USE_SSL"], StringComparison.InvariantCultureIgnoreCase);
            ...
            _igniteClient = CacheFactory.ConnectAsClient(CacheFactory.GetIgniteClientConfiguration(aspNetCoreIgniteEndpoint, aspNetCoreIgniteUserName, aspNetCoreIgnitePassword, aspNetCoreIgniteUseSsl,
                aspNetCoreIgniteSslCertificatePath, aspNetCoreIgniteSslCertificatePassword));
        }

        public ICacheClient<TKey, TData> GetOrCreateCacheClient<TKey, TData>(string cacheName, Action<CacheClientConfiguration> extendConfigurationAction = null)
        {
            return Policy
