...
commandLineApplication.OnExecute(async () =>
{
    ...
    bool useSsl = "true".Equals(Configuration["USE_SSL"], StringComparison.OrdinalIgnoreCase);
    ...
    _igniteServerRunner.SetOffHeapMemoryLimit(offHeapArgument.HasValue()
        ? int.Parse(offHeapArgument.Value())
        : defaultOffHeapMemory);

    _igniteServerRunner.SetOnHeapMemoryLimit(onHeapArgument.HasValue()
