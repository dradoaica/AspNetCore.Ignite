...
CreateIgniteConfiguration();
ConfigureIgniteLogging();
...
commandLineApplication.OnExecute(async () =>
{
    ...
    var enableAuthentication =
        "true".Equals(configuration["ENABLE_AUTHENTICATION"], StringComparison.OrdinalIgnoreCase);
    ...
    igniteServerRunner = new IgniteServerRunner(metricsExpireTime, metricsLogFrequency, metricsUpdateFrequency,
...
static void CreateIgniteConfiguration()
{
...
static void ConfigureIgniteLogging()
{
    // Configure NLog
